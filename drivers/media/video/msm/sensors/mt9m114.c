...
// 直到为0或者   50ms以上
{MT9M114_COMMAND_REGISTER, MT9M114_COMMAND_REGISTER_SET_STATE, MSM_CAMERA_I2C_UNSET_WORD_MASK, MSM_CAMERA_I2C_CMD_POLL},
//{ DELAY,  { 50 } },
...
//[APGA Settings M 75% 2012/03/22 02:31:50]
{0x3640, 0x0330,},
{0x3642, 0x898D,},			
{0x3644, 0x0011,},			
{0x3646, 0x900E,},			
...
{0xC95E, 0x0003,},		
 ...
 {0xC892, 0x01C3,},  // CAM_AWB_CCM_L_0                                                                          
 {0xC894, 0xFF17,},  // CAM_AWB_CCM_L_1                                                                          
 {0xC896, 0x0026,},  // CAM_AWB_CCM_L_2                                                                          
 {0xC898, 0xFFB6,},  // CAM_AWB_CCM_L_3                                                                          
 {0xC89A, 0x0128,},  // CAM_AWB_CCM_L_4                                                                          
 {0xC89C, 0x0022,},  // CAM_AWB_CCM_L_5                                                                          
 {0xC89E, 0xFF97,},  // CAM_AWB_CCM_L_6                                                                          
 {0xC8A0, 0xFF15,},  // CAM_AWB_CCM_L_7                                                                          
 {0xC8A2, 0x0256,},  // CAM_AWB_CCM_L_8                                                                          
...
// {0xC8F3, 0x0002,},  // CAM_AWB_AWB_YSCALE                                                                     
 ...
 {0xC92A, 0x99,MSM_CAMERA_I2C_BYTE_DATA},		  // CAM_LL_START_SATURATION                                         
...
int32_t mt9m114_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	rc = gpio_request(reset_gpio,"mt9m114");
	if (rc) 
	{
...
int mt9m114_sensor_set_effect (struct msm_sensor_ctrl_t *s_ctrl, char effect)
{
	int rc = 0;
...
int mt9m114_sensor_set_whitebalance (struct msm_sensor_ctrl_t * s_ctrl,char wb)
{
     long rc = 0;
...
static struct msm_sensor_fn_t mt9m114_func_tbl = {
	...
	.sensor_power_up = mt9m114_sensor_power_up,
	.sensor_power_down = mt9m114_sensor_power_down,
	.sensor_set_whitebalance_yuv = mt9m114_sensor_set_whitebalance,
    .sensor_set_effect_yuv =  mt9m114_sensor_set_effect,
...
module_init(mt9m114_sunny_init_module);
