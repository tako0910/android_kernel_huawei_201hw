...
struct msm_battery_8921gauge {
	...
	int (* get_battery_capacity_rm)(void);
	short (* get_battery_current) (void);
	int (* get_battery_tte) (void);
	int (* get_battery_ttf) (void);
	int (* is_battery_full) (void);
	int (* is_battery_exist) (void);
	int (*is_battery_discharging)(void);
	int (*get_battery_fcc)(void* priv);
	int (*get_battery_health)(void *priv);
	int (*get_battery_status)(void *priv);
};
#endif
